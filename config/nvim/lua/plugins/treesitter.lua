...
M.config = function()
    ...
    -- }
    -- Custom text objects
    local textobj_prefixes = Globals.treesitter.textobj_prefixes
    local textobj_suffixes = Globals.treesitter.textobj_suffixes
    local textobj_sel_keymaps = {}
    local textobj_swap_keymaps = {}
    local textobj_move_keymaps = {
        enable = Globals.plugin.ts_textobjects,
    ...
    vim.g.ts_hint_textobject_keys = Globals.treesitter.hint_labels -- Requires https://github.com/mfussenegger/nvim-ts-hint-textobject/pull/2
    ...
    require("nvim-treesitter.configs").setup {
        ...
        context_commentstring = {
            enable = Globals.plugin.ts_context_commentstring.active,
            config = { css = "// %s" },
        },
        -- indent = {enable = true, disable = {"python", "html", "javascript"}},
        -- TODO seems to be broken
        indent = { enable = { "javascriptreact" } },
        autotag = { enable = Globals.plugin.ts_autotag.active },
        textobjects = {
            swap = {
                enable = Globals.plugin.ts_textobjects,
        ...
        textsubjects = {
            enable = Globals.plugin.ts_textsubjects,
            keymaps = { ["."] = "textsubjects-smart", [";"] = "textsubjects-big" },
        },
        playground = {
            enable = Globals.plugin.ts_playground.active,
            disable = {},
        ...
        rainbow = {
            enable = Globals.plugin.ts_rainbow.active,
