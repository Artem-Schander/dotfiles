...
_G.packer_plugins = {
  ...
  ["csv.vim"] = {
    loaded = true,
    path = "/home/va-artem/.local/share/nvim/site/pack/packer/start/csv.vim"
  },
  ["editorconfig-vim"] = {
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'git-blame.nvim', 'gitsigns.nvim', 'hop.nvim', 'indent-blankline.nvim', 'numb.nvim', 'nvim-bqf', 'playground', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
